<?php
//This is entering the users data into the db from the previous page form - tracker.php
    $dated = $_POST['datedata'];
    $amount = $_POST['amountdata'];
    $emotion = $_POST['emotiondata'];
    
    include("../../MoneyInMind/connect.php");
    $updatequery = "INSERT INTO MiMtracker (id, Date, Spending, Emotion) VALUES (NULL,'$dated','$amount','$emotion')";
                ...
                <div class="col-2"></div>
                    ...
                    <div class="col-8">
                        <div id="main-con" class="container" width="400px">
                            ...
                            <a class="btn btn-primary" href="tracker.php" role="button">Back</a>
                        </div>
                    </div>
