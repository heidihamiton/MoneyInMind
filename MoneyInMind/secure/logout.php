                ...
                <div class="col"></div>
                    ...
                    <div class="col">
                        <div id="main-con" class="container" style="width: 350px;">
                            ...
                            <div class="row">
                                <p>Logged out mistakenly? </p><small class="mt-1">Click below to log back in.</small>
                                <a role="button" href="log.php" class="btn btn-primary btn-lg btn-block">Login Page</a>
                            </div>
                        </div>
                    </div>
